...
export default function Example() {
  ...
  const handleCartClick = () => {
    router.push('/cart'); // Ensure that this triggers navigation
  };
  ...
  return (
    <div className="bg-white w-full relative z-10 ">
                      ...
                      {category.featured.map((item) => (
                        <div key={item.name} className="group relative text-sm">
                          <div className="aspect-h-1 aspect-w-1 overflow-hidden rounded-lg bg-gray-100 group-hover:opacity-75">
                            <Image alt={item.imageAlt} src={item.imageSrc} className="object-cover object-center" />
                          </div>
      ...
      <header className="relative bg-white">
        <p className="flex h-10 items-center justify-center bg-yellow-400 px-4 text-sm font-medium text-white sm:px-6 lg:px-8">
          Get free delivery on orders over $100  <span>  Pan india Delivery</span>
          </p>  
